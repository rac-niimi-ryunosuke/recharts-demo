    ...
    <div className="chart-container">
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="PC" stroke="#8884d8" strokeWidth={2} dot={{ r: 4 }} />
          <Line type="monotone" dataKey="スマホ" stroke="#82ca9d" strokeWidth={2} dot={{ r: 4 }} />
          <Line type="monotone" dataKey="タブレット" stroke="#ffc658" strokeWidth={2} dot={{ r: 4 }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
